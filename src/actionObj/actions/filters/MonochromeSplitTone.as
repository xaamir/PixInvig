package actionObj.actions.filters
{
	...
	public class MonochromeSplitTone extends FilterBase
	{
		...
		public static const label:String="Split";
		
		override public function getLabel():String{
			return label;
		}
		
		public function MonochromeSplitTone(){
			
		}
		
		override public function prepareFilters():void{			
			// Step 1. Curves #1. RGB Curve: 3 points, S-curve.
			...
			curves2CoordArr.push(new Coordinate(112,150));
			...
			// Step 5C. Curves #5. Apply color adjustments. Blue Curve: 2 points.
			curves7Poly = new Polynomial();
			var curves7CoordArr:Array=new Array();
			curves7CoordArr.push(new Coordinate(0,59));
			curves7CoordArr.push(new Coordinate(255, 112));
