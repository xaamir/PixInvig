package actionObj.actions.filters
{
	...
	public class SepiaLowContrast extends FilterBase
	{
		...
		public static const desc:String =
			"Sepia Low Contrast: This filter almost desaturates the images and adds a sepia tint to it."
			+ " Contrast is also reduced for a more old-timey look.";

		public static const label:String="Timey";
		
		override public function getLabel():String{
			return label;
		}
		
		public function SepiaLowContrast(){
			
		}
				
		override public function prepareFilters():void{
			// Step 1. Curves #1. Reduce contrast, brighten. RGB Curve: 3 points.
			curves1Poly = new Polynomial();
			var curves1CoordArr:Array=new Array();
			curves1CoordArr.push(new Coordinate(0, 38));
			curves1CoordArr.push(new Coordinate(113,151));
			curves1CoordArr.push(new Coordinate(255,217));
